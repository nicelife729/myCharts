...
{{- if .Values.global -}}
    {{- if .Values.global.storageClass -}}
        ...
        {{- end -}}
    {{- else -}}
        {{- if .Values.persistence.rsStorageClass -}}
              {{- if (eq "-" .Values.persistence.rsStorageClass) -}}
                  {{- printf "storageClassName: \"\"" -}}
              {{- else }}
                  {{- printf "storageClassName: %s" .Values.persistence.rsStorageClass -}}
              {{- end -}}
        {{- end -}}
    {{- end -}}
{{- else -}}
